...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> arg = getArguments().getIntegerArrayList(TAG_FRIEND_RES_IDS);
		Integer test[] = new Integer[arg.size()];
		test = arg.toArray(test);


		// TODO: Start the DownloaderTask
		downloaderTask.execute(test);
